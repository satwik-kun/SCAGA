...
from utils import convert_cuda, load_config, load_runtime_config
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss_type', type=str, default='importance', choices=['mse', 'importance', 'residual', 'saturated_residual'],
    ...
    save_dir = os.path.join(out_root, args.name)
    ...
    for epoch in range(start_epoch, args.epoch + 1):
        ...
        for k, item in enumerate(train_loader):
            ...
            # Loss calculations
            loss_type = getattr(args, 'loss_type', 'importance')
