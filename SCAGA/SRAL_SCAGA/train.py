...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='SRAL_SCAGA')
    ...
    parser.add_argument('--loss_type', type=str, default='saturated_residual', choices=['mse', 'importance', 'residual', 'saturated_residual'],
    ...
    for epoch in range(start_epoch, args.epoch + 1):
        ...
        for k, item in enumerate(train_loader):
            ...
            # Loss calculations
            loss_type = getattr(args, 'loss_type', 'saturated_residual')
